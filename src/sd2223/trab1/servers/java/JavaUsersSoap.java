...
public class JavaUsersSoap implements Users {
    ...
    public Result<String> createUser(User user) {
        ...
        return Result.ok( String.format("%s@%s",user.getName(), SoapUsersServer.getDomain()));
    }
    ...
    public Result<User> deleteUser(String name, String pwd) {
        ...
        synchronized (users){
            ...
            String domain = SoapUsersServer.getDomain();
